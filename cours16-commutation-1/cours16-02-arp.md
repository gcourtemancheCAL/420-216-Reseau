...
Afin d'accélérer les opérations et d'aider à prévenir les erreurs, un hôte va diffuser un message ARP non sollicité visant à informer de les autres hôtes sur le réseau de son association IP/MAC. 

Le but de ce message est, entre autre, de rafraichir les caches ARP des autres équipements sur le réseau.
