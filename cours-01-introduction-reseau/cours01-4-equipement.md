...
<img src="img/Pasted image 20260114101103.png" width="400" />

Appareil responsable de convertir le signal analog du câble coaxial en signal digital Ethernet. Permet à votre équipement de communiquer avec l'équipement de votre fournisseur de service internet.
#### Routeur résidentiel multifonction

<img src="img/Pasted image 20260114101638.png" width="400" />

Équipement résidentiel combinant les fonctions de plusieurs appareils différents : routeur, commutateur et, généralement, point d'accès sans-fil.
